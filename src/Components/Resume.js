  ...
  render() {
     if (this.props.data) {
        ...
        var education = this.props.data.education.map(function(edu) {
            // education is an array so we use map on the education object to get each:
        ...
        var work = this.props.data.work.map(function(job) {
            // work is an array so we use map on the work object to get each:
        ...
        var skills = this.props.data.skills.map(function(skill) {
            // skills is an array so we use map on the skills object to get each:
